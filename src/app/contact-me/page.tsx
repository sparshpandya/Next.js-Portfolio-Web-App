...
export const metadata = {
    ...
    description: 'contact/connect with me by sending me your name, email and a message.',
    keywords: "sparsh's portfolio, sparsh's contact, connect with sparsh",
                        ...
                        <ul className="contact-info space-y-6 md:space-y-10 2xl:space-y-12 *:flex *:flex-wrap *:items-center *:gap-5">
                            <li>
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm">Kitchener, Ontario</p>
                                </div>
                            </li>
                            <li>
                                <div className="flex justify-center w-12 icon">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm">sparshpandya228@gmail.com</p>
                                </div>
                            </li>
                            <li>
                                <div className="flex justify-center w-12 icon">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm">+1 548 577 1364</p>
                                </div>
                            </li>
                        </ul>
                    </div>
