        ...
        <div
            ...
            <div className="p-3 max-xl:mb-3 overflow-hidden minfo__sidebar bg-white dark:bg-nightBlack rounded-2xl">
                <div className="mx-4 mt-12 text-center user-info lg:mx-6">
                    ...
                    <h6 className="mb-1 text-lg font-semibold text-black dark:text-white name">Sparsh Pandya</h6>
                ...
                <div className="px-4 py-5 lg:py-6 lg:px-6 rounded-2xl md:px-8 bg-flashWhite dark:bg-metalBlack">
                    ...
                    <div className="flex items-center justify-between my-4 space-x-4 skills_circle *:space-y-2 *:text-center">
                        <div className="progressCircle">
                            ...
                            <p className="text-[13px] font-normal dark:font-light text-black dark:text-white/90">Next.js</p>
                        </div>
                        <div className="progressCircle">
                            ...
                            <p className="text-[13px] font-normal dark:font-light text-black dark:text-white/90">React.js</p>
                        </div>
                        <div className="progressCircle">
                            <div className="relative w-12 h-12 circle" data-percent="80" data-circlefill="#00BC91" data-circleempty="#777777">
                                <div className="absolute inset-0 text-[13px] font-medium label flex-center">80%</div>
                            </div>
                            <p className="text-[13px] font-normal dark:font-light text-black dark:text-white/90">Typescript</p>
                        </div>
                        <div className="progressCircle">
                            <div className="relative w-12 h-12 circle" data-percent="90" data-circlefill="#00BC91" data-circleempty="#777777">
                                <div className="absolute inset-0 text-[13px] font-medium label flex-center">90%</div>
                            </div>
                            <p className="text-[13px] font-normal dark:font-light text-black dark:text-white/90">Node.js</p>
                        </div>
                    </div>
                    <div className="mt-6">
